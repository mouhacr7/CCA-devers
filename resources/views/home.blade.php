    ...
    <div class="banner-bottom">
        <div class="col-md-3 wthree_banner_bottom_grid">
            <div class="wthree_banner_bottom_grid1">
                <img src="layouts/images/1.jpg" alt=" " class="img-responsive" />
        ...
        <div class="col-md-3 agileits_w3layouts_banner_bottom_grid">
            <div class="hovereffect">
                <img src="layouts/images/4.jpg" alt=" " class="img-responsive" />
                <div class="overlay">
                    <h3 class="w3_instruments">Music Instruments</h3>
                    <div class="rotate">
                        <p class="group1">
        ...
        <div class="container">
            <div class="w3_agile_about_grids">
                <div class="col-md-6 w3_agile_about_grid_left">
                    <img src="layouts/images/5.jpg" alt=" " class="img-responsive" />
                </div>
    ...
    <div class="features">
        <div class="container">
            <div class="col-md-6 agile_features_left">
                <img src="layouts/images/7.jpg" alt=" " class="img-responsive" />
            </div>
